    ...
    response(): Status {
        ...
        switch (decision as Decision) {
            case Decision.LEFT:
                this.cat.leftMove();
                break;
            case Decision.LEFT_DOWN:
                this.cat.leftDownMove();
                break;
            case Decision.LEFT_UP:
                this.cat.leftUpMove();
                break;
            case Decision.RIGHT:
                this.cat.rightMove();
                break;
            case Decision.RIGHT_DOWN:
                this.cat.rightDownMove();
                break;
            case Decision.RIGHT_UP:
                this.cat.rightUpMove();
        }
        return Status.DOING;
    }
